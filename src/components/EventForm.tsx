    ...
    return (
        <form className='flex-2 bg-slate-50 p-3 rounded-md ml-10 w-[30vw] flex flex-col justify-between'>
            ...
            <div className='flex justify-between p-4'>
                <button className='bg-red-800 py-2 px-3 font-bold text-white rounded-xl'>Clear Event</button>
                <button className='bg-yellow-800 py-2 px-3 font-bold text-white rounded-xl'>Save Changes</button>
            </div>
        </form>
    )
}